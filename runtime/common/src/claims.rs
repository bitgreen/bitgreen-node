...
decl_event!(
	...
	{
		/// Someone claimed some BITGS. [who, ethereum_address, amount]
...
decl_module! {
	pub struct Module<T: Trait> for enum Call where origin: T::Origin {
		...
		/// Make a claim to collect your BITGS.
		///
		...
		/// Mint a new claim to collect BITGS.
		///
		/// The dispatch origin for this call must be _Root_.
		///
		/// Parameters:
		/// - `who`: The Ethereum address allowed to collect this claim.
		/// - `value`: The number of BITGS that will be claimed.
		/// - `vesting_schedule`: An optional vesting schedule for these BITGS.
		///
		/// <weight>
		/// The weight of this call is invariant over the input parameters.
		...
		/// Make a claim to collect your BITGS by signing a statement.
		///
		/// The dispatch origin for this call must be _None_.
		///
		/// Unsigned Validation:
