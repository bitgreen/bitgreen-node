	...
	impl<T: Config> Pallet<T> {
		...
		pub fn transfer_native_currency(
			...
			Self::deposit_event(Event::Transferred(
				CurrencyId::Token(TokenSymbol::BITG),
				from,
				to,
				amount,
			));
...
impl<T: Config> MultiCurrency<T::AccountId> for Pallet<T> {
	...
	fn minimum_balance(currency_id: Self::CurrencyId) -> Self::Balance {
		match currency_id {
			...
			CurrencyId::Token(TokenSymbol::BITG) => T::NativeCurrency::minimum_balance(),
	...
	fn total_issuance(currency_id: Self::CurrencyId) -> Self::Balance {
		match currency_id {
			...
			.unwrap_or_default(),
			CurrencyId::Token(TokenSymbol::BITG) => T::NativeCurrency::total_issuance(),
	...
	fn total_balance(currency_id: Self::CurrencyId, who: &T::AccountId) -> Self::Balance {
		match currency_id {
			...
			CurrencyId::Token(TokenSymbol::BITG) => T::NativeCurrency::total_balance(who),
	...
	fn free_balance(currency_id: Self::CurrencyId, who: &T::AccountId) -> Self::Balance {
		match currency_id {
			...
			CurrencyId::Token(TokenSymbol::BITG) => T::NativeCurrency::free_balance(who),
	...
	fn ensure_can_withdraw(currency_id: Self::CurrencyId, who: &T::AccountId, amount: Self::Balance) -> DispatchResult {
		match currency_id {
			...
			CurrencyId::Token(TokenSymbol::BITG) => T::NativeCurrency::ensure_can_withdraw(who, amount),
	...
	fn transfer(
		...
		match currency_id {
			...
			CurrencyId::Token(TokenSymbol::BITG) => T::NativeCurrency::transfer(from, to, amount)?,
	...
	fn deposit(currency_id: Self::CurrencyId, who: &T::AccountId, amount: Self::Balance) -> DispatchResult {
		...
		match currency_id {
			...
			CurrencyId::Token(TokenSymbol::BITG) => T::NativeCurrency::deposit(who, amount)?,
	...
	fn withdraw(currency_id: Self::CurrencyId, who: &T::AccountId, amount: Self::Balance) -> DispatchResult {
		...
		match currency_id {
			CurrencyId::ERC20(_) => return Err(Error::<T>::ERC20InvalidOperation.into()),
			CurrencyId::Token(TokenSymbol::BITG) => T::NativeCurrency::withdraw(who, amount)?,
	...
	fn can_slash(currency_id: Self::CurrencyId, who: &T::AccountId, amount: Self::Balance) -> bool {
		match currency_id {
			...
			CurrencyId::Token(TokenSymbol::BITG) => T::NativeCurrency::can_slash(who, amount),
	...
	fn slash(currency_id: Self::CurrencyId, who: &T::AccountId, amount: Self::Balance) -> Self::Balance {
		match currency_id {
			CurrencyId::ERC20(_) => Default::default(),
			CurrencyId::Token(TokenSymbol::BITG) => T::NativeCurrency::slash(who, amount),
...
impl<T: Config> MultiCurrencyExtended<T::AccountId> for Pallet<T> {
	...
	fn update_balance(currency_id: Self::CurrencyId, who: &T::AccountId, by_amount: Self::Amount) -> DispatchResult {
		match currency_id {
			CurrencyId::ERC20(_) => return Err(Error::<T>::ERC20InvalidOperation.into()),
			CurrencyId::Token(TokenSymbol::BITG) => T::NativeCurrency::update_balance(who, by_amount)?,
...
impl<T: Config> MultiLockableCurrency<T::AccountId> for Pallet<T> {
	...
	fn set_lock(
		...
		match currency_id {
			...
			CurrencyId::Token(TokenSymbol::BITG) => T::NativeCurrency::set_lock(lock_id, who, amount),
	...
	fn extend_lock(
		...
		match currency_id {
			CurrencyId::ERC20(_) => Err(Error::<T>::ERC20InvalidOperation.into()),
			CurrencyId::Token(TokenSymbol::BITG) => T::NativeCurrency::extend_lock(lock_id, who, amount),
	...
	fn remove_lock(lock_id: LockIdentifier, currency_id: Self::CurrencyId, who: &T::AccountId) -> DispatchResult {
		match currency_id {
			CurrencyId::ERC20(_) => Err(Error::<T>::ERC20InvalidOperation.into()),
			CurrencyId::Token(TokenSymbol::BITG) => T::NativeCurrency::remove_lock(lock_id, who),
...
impl<T: Config> MultiReservableCurrency<T::AccountId> for Pallet<T> {
	fn can_reserve(currency_id: Self::CurrencyId, who: &T::AccountId, value: Self::Balance) -> bool {
		match currency_id {
			...
			CurrencyId::Token(TokenSymbol::BITG) => T::NativeCurrency::can_reserve(who, value),
	...
	fn slash_reserved(currency_id: Self::CurrencyId, who: &T::AccountId, value: Self::Balance) -> Self::Balance {
		match currency_id {
			...
			CurrencyId::Token(TokenSymbol::BITG) => T::NativeCurrency::slash_reserved(who, value),
	...
	fn reserved_balance(currency_id: Self::CurrencyId, who: &T::AccountId) -> Self::Balance {
		match currency_id {
			...
			CurrencyId::Token(TokenSymbol::BITG) => T::NativeCurrency::reserved_balance(who),
	...
	fn reserve(currency_id: Self::CurrencyId, who: &T::AccountId, value: Self::Balance) -> DispatchResult {
		match currency_id {
			...
			CurrencyId::Token(TokenSymbol::BITG) => T::NativeCurrency::reserve(who, value),
	...
	fn unreserve(currency_id: Self::CurrencyId, who: &T::AccountId, value: Self::Balance) -> Self::Balance {
		match currency_id {
			...
			CurrencyId::Token(TokenSymbol::BITG) => T::NativeCurrency::unreserve(who, value),
