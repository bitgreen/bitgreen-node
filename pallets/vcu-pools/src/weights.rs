...
//! Autogenerated weights for pallet_vcu_pools
//!
...
/// Weight functions needed for pallet_vcu_pools.
...
/// Weights for pallet_vcu_pools using the Substrate node and recommended hardware.
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	// Storage: VCU RetiredVCUs (r:0 w:1)
	fn retire() -> Weight {
