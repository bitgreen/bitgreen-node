...
//! Autogenerated weights for pallet_vcu
//!
...
// --output=./pallets/vcu/src/weights.rs
...
/// Weight functions needed for pallet_vcu.
...
/// Weights for pallet_vcu using the Substrate node and recommended hardware.
