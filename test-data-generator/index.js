...
const TEST_VALIDATOR_TWO = "gun zebra clever surprise cement bench swear blanket push dust fame gather";
...
class BitgreenNode {
  ...
  async create_project(account) {
    let project_data = {
        ...
        description: "At its core, the project employs a multifaceted approach, combining innovative technologies with sustainable practices",
        location: [(100, 100), (100, 100)],
        images: ["https://bitgreen-gateway.infura-ipfs.io/ipfs/bafybeigp2twcwpmtmohtl4y54npwoczg5sypip6ei2t5a4cwxwd6yuwlru"],
        ...
        sdgDetails: [
          {
            sdgType: "NoPoverty",
            description: "No Poverty SDG employs a multi-faceted approach that encompasses social protection programs, sustainable economic growth, and targeted interventions to uplift marginalized communities",
  ...
  async validate_payment(account) {
    ...
    const tx = await this.api.tx.dex.validateBuyOrder(buy_order, 0, "0x848f743b40ecfdf1d3ff85fdcebf57f526e924c0ca2e329a4624caab722ca47a");
